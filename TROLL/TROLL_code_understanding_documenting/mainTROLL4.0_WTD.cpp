...
if (_WATER_RETENTION_CURVE==1) {
                ...
                if(Ks_cap[l][d] < 1e-18) {
                    Ks_cap[l][d] = 1e-18; // BR changing the limit to avoid ks and ks harmonic = 0 and as a consequence to hydraulic locking
                }
...
if (_UNIFIED_VERT_WATER_FLUX == 0) {
                ...
                // (2) the residual receiver capacity of the upper layer,
