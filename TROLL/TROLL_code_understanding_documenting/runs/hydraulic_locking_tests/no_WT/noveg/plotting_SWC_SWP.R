  ...
  # -----------------------------
  base_dir <- "~/Desktop/Postdoc_Toulouse/Postdoc_Toulouse/TROLL/TROLL_code_understanding_documenting/runs/hydraulic_locking_tests/no_WT/noveg/"
  ...
  files_df <- tibble(
    ...
    pedology_path = rep(
      file.path("~/Desktop/Postdoc_Toulouse/Postdoc_Toulouse/TROLL/TROLL_code_understanding_documenting/runs/hydraulic_locking_tests/no_WT/noveg/common_inputs/Paracou_input_pedology.txt"),
      1
    )
  ) %>%
    mutate(
