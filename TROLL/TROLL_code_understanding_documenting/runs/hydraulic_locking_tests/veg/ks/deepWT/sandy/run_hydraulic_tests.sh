...
RUN_DIR="$BASE_DIR/runs/hydraulic_locking_tests/veg/ks/deepWT/sandy/$RUN"
OUTPUT_DIR="$RUN_DIR/output"
INPUT_DIR="$BASE_DIR/runs/hydraulic_locking_tests/veg/ks/deepWT/sandy/common_inputs"
