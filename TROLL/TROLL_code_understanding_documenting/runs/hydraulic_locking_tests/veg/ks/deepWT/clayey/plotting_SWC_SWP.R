...
# -----------------------------
base_dir <- "~/Desktop/Postdoc_Toulouse/Postdoc_Toulouse/TROLL/TROLL_code_understanding_documenting/runs/hydraulic_locking_tests/veg/ks/deepWT/clayey/"

files_df <- tibble(
  model_name = c(
    "theta1e-6_ksfloor1e-12_veg_redprec_deepwt2_clayey",
    "theta1e-6_ksfloor1e-10_veg_redprec_deepwt2_clayey"
  ),
  experiment_dir = file.path(base_dir, c(
    "theta1e-6_ksfloor1e-12_veg_redprec_deepwt2_clayey/output",
    "theta1e-6_ksfloor1e-10_veg_redprec_deepwt2_clayey/output"
  )),
  pedology_path = rep(
      file.path("~/Desktop/Postdoc_Toulouse/Postdoc_Toulouse/TROLL/TROLL_code_understanding_documenting/runs/hydraulic_locking_tests/veg/ks/deepWT/clayey/common_inputs/Paracou_input_pedology.txt"),
    2
  )
) %>%
  mutate(
...
raster_all <- data_long_all %>%
  ...
  mutate(
    ...
    model_name = recode(
      model_name,
      "theta1e-6_ksfloor1e-12_veg_redprec_deepwt2_clayey" = "ksfloor1e-12_veg_redprec_deepwt_clayey",
      "theta1e-6_ksfloor1e-10_veg_redprec_deepwt2_clayey" = "ksfloor1e-10_veg_redprec_deepwt_clayey"
    ),
    model_name = factor(
      model_name,
      levels = c(
        "ksfloor1e-12_veg_redprec_deepwt_clayey",
        "ksfloor1e-10_veg_redprec_deepwt_clayey"
      )
    )
  )
