...
# # -----------------------------
model_path <- "~/Desktop/Postdoc_Toulouse/Postdoc_Toulouse/TROLL/TROLL_code_understanding_documenting/runs/sensitivity_tests2"
model_name <- c("shallow_variable_sandy2", "deep_variable_sandy2")
#                , "deep_variable_sandy",
...
pairs <- list(list(label = "Variable — Sandy",      models = c("shallow_variable_sandy2","deep_variable_sandy2"))
...
pairs <- list(
  list(label = "",      models = c("shallow_variable_sandy2", "deep_variable_sandy2")))
# pairs <- list(
#   list(label = "Variable — Sandy",      models = c("shallow_variable_sandy",      "deep_variable_sandy")),
#   list(label = "Variable — Clayey",     models = c("shallow_variable_clayey",     "deep_variable_clayey")),
#   list(label = "Intermediate — Sandy",  models = c("shallow_intermediate_sandy",  "deep_intermediate_sandy")),
...
pairs <- list(
  list(label = "Variable — Sandy",      models = c("shallow_variable_sandy2", "deep_variable_sandy2")))
#        ,      "deep_variable_sandy")),
#   list(label = "Variable — Clayey",     models = c("shallow_variable_clayey",     "deep_variable_clayey")),
#   list(label = "Intermediate — Sandy",  models = c("shallow_intermediate_sandy",  "deep_intermediate_sandy")),
#   list(label = "Intermediate — Clayey", models = c("shallow_intermediate_clayey", "deep_intermediate_clayey")),
...
pairs <- list(
  list(label = "Variable — Sandy",      models = c("shallow_variable_sandy2", "deep_variable_sandy2")))
                                                   # ,      "deep_variable_sandy")), list(label = "Variable — Clayey",     models = c("shallow_variable_clayey",     "deep_variable_clayey")))
...
for (i in seq_along(pairs)) {
  ...
  p <- ggplot(df_pair, aes(depth_max, m, color = season, group = season)) +
    ...
    theme_bw() +
    coord_flip() +
    scale_x_reverse("Depth [ m ]",limits = c(2.5, 0)) +
    scale_y_log10(expression("|SWP| ["~MPa~"]")) +
    labs(title = pp$label, color = NULL) +
    facet_wrap(~simulation, ncol = 2) +
    theme(
