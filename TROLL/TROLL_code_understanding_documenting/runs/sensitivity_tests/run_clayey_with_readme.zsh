...
# List of clayey experiments to run (folder names under $BASE)
# exps=(
#   shallow_variable_clayey OK
#   shallow_intermediate_clayey OK
#   shallow_thin_clayey OK
#   deep_variable_clayey OK
#   deep_intermediate_clayey
#   deep_thin_clayey OK
# )
exps=(deep_variable_clayey)
...
echo "All clayey experiments finished."
