...
RUN_DIR="$BASE_DIR/runs/hydraulic_locking_tests/veg/ks/$RUN"
TROLL_code_understanding_documenting/runs/thetha_w_tests/veg/deepWT/sandy
OUTPUT_DIR="$RUN_DIR/output"
INPUT_DIR="$BASE_DIR/runs/hydraulic_locking_tests/veg/common_inputs"
