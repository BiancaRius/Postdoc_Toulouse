  ...
  # -----------------------------
  base_dir <- "~/Desktop/Postdoc_Toulouse/Postdoc_Toulouse/TROLL/TROLL_code_understanding_documenting/runs/hydraulic_locking_tests/veg/ks/"
  
  files_df <- tibble(
    model_name = c(
      "theta1e-6_ksfloor1e-12_veg_redprec",
      "theta1e-6_ksfloor1e-10_veg_redprec",
      "theta1e-6_ksfloor1e-8_veg_redprec"
    ),
    experiment_dir = file.path(base_dir, c(
      "theta1e-6_ksfloor1e-12_veg_redprec/output",
      "theta1e-6_ksfloor1e-10_veg_redprec/output",
      "theta1e-6_ksfloor1e-8_veg_redprec/output"
      )),
    pedology_path = rep(
  ...
  raster_all <- data_long_all %>%
    ...
    mutate(
      ...
      model_name = recode(
        model_name,
        "theta1e-6_ksfloor1e-12_veg_redprec" = "ksfloor1e-12_shallowWT",
        "theta1e-6_ksfloor1e-10_veg_redprec" = "ksfloor1e-10_shallowWT",
        "theta1e-6_ksfloor1e-8_veg_redprec"  = "ksfloor1e-8_shallowWT"
      ),
      model_name = factor(
        model_name,
        levels = c(
          "ksfloor1e-12_shallowWT",
          "ksfloor1e-10_shallowWT",
          "ksfloor1e-8_shallowWT"
        )
      )
    )
  ...
  # Save figures
  # -----------------------------
  output_dir <- "~/Desktop/Postdoc_Toulouse/Postdoc_Toulouse/TROLL/TROLL_code_understanding_documenting/runs/hydraulic_locking_tests/veg/ks/"
